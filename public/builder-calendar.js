(function () {
  ...
  async function loadCalendar() {
    ...
    if (!events.length) {
      listEl.innerHTML =
        '<div class="bp-card"><p class="bp-muted">No visits in this period. Request a visit to schedule with Summit Flooring.</p></div>';
      return;
    }
  ...
  document.getElementById('btnExportIcs')?.addEventListener('click', async (e) => {
    ...
    a.download = 'summit-flooring-schedule.ics';
    a.click();
  });

...
(function () {
  ...
  async function init() {
    ...
    brand.setAttribute('aria-label', 'Summit Flooring CRM — início');
    brand.innerHTML =
      '<img src="/assets/logoSummitFlooring.png" alt="" class="crm-shared-nav__brand-logo" width="64" height="64" onerror="this.style.display=\'none\'" />';

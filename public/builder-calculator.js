(function () {
  ...
  function printEstimatePdf() {
    ...
    w.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${label}</title>
      <style>body{font-family:Inter,sans-serif;padding:32px;color:#1c1c1f;max-width:720px;margin:0 auto}
      h1{font-size:1.25rem;margin:0 0 8px}.muted{color:#64748b;font-size:13px}
      .hero{background:#1c1c1f;color:#fff;padding:20px;border-radius:10px;margin:16px 0}
      ...
      <img src="/assets/logoSummitFlooring.png" alt="" width="48" onerror="this.style.display='none'" />
      <h1>Summit Flooring &mdash; Partner estimate</h1>
      ...
      <p class="fine">Ballpark estimate only. Not a binding quote. Final pricing depends on site conditions and scope. Contact Summit Flooring for a formal proposal.</p></body></html>`);
    w.document.close();
    w.focus();

...
(function () {
  ...
  function renderOwnerSignatureCol(ownerSig) {
    ...
    const ownerImg = owner.image_url
      ...
      : '<span class="qp-muted-text">Summit Flooring</span>';
    ...
    return `
      <header class="qp-header">
        <div class="qp-header__brand">
          <img class="qp-logo" src="/assets/logoSummitFlooring.png" alt="" width="68" height="68" onerror="this.style.display='none'" />
  ...
  async function load() {
    ...
    try {
      ...
      document.title = `Quote ${q.quote_number || q.id} — Summit Flooring`;
    } catch {

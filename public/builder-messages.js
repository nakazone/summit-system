...
(function () {
  ...
  function sfBadge() {
    return (
      window.builderPortalCommon?.sfContactBadgeHtml?.('Summit Flooring') ||
      '<span class="bp-sf-contact-badge" title="Summit Flooring"><img src="/assets/logoSummitFlooring.png" alt="Summit Flooring" width="26" height="26" /></span>'
    );
  }
  ...
  function renderMessages(host, messages) {
    ...
    (messages || []).forEach((m) => {
      ...
      const readMark = mine
        ? m.is_read
          ? ' <span class="bp-msg-read" title="Read by Summit Flooring">&#10003;&#10003;</span>'
    ...
    if (!(messages || []).length) {
      html +=
        '<p class="bp-muted bp-msg-empty">No messages yet. Say hello to your Summit Flooring team.</p>';
    }
    html += '</div>';

...
(function () {
  ...
  const SF_LOGO_URL = '/assets/logoSummitFlooring.png?v=20260531';
  ...
  /** Badge SF nos avatares de contactos Summit Flooring (portal builder). */
  function sfContactBadgeHtml(title) {
    const t = escapeHtml(title || 'Summit Flooring');
  ...
  function pageHeaderHtml({ title, subtitle = '', actionsHtml = '', eyebrow = 'Summit Flooring Partner' }) {

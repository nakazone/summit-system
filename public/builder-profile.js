...
(function () {
  ...
  function renderManager(mgr) {
    ...
    if (!mgr) {
      block.innerHTML =
        '<h2 class="bp-profile-section__title">Your Summit Flooring manager</h2><p class="bp-muted">Your account manager will be assigned by Summit Flooring.</p>';
      return;
    }
    ...
    const badge =
      ...
      '';
    block.innerHTML = `
      <h2 class="bp-profile-section__title">Your Summit Flooring manager</h2>

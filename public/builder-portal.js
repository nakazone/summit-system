(function () {
  ...
  function renderWelcomeManager(mgr) {
    ...
    const badge =
      window.builderPortalCommon?.sfContactBadgeHtml?.('Summit Flooring manager') ||
      '<span class="bp-sf-contact-badge" title="Summit Flooring"><img src="/assets/logoSummitFlooring.png?v=20260529" alt="Summit Flooring" width="26" height="26" /></span>';
    ...
    wrap.innerHTML = `
      <p class="bp-welcome__manager-head">Your Summit Flooring manager</p>
  ...
  function renderFirstVisitBanner(isFirst, mgr) {
    ...
    const mgrLine = mgr?.name
      ...
      : 'Your dedicated Summit Flooring team is ready to help.';
    el.innerHTML = `
    ...
    if (dash.success && dash.data) {
      ...
      if (sub) {
        sub.textContent = u.company
          ? `${u.company} \u2014 overview of your projects with Summit Flooring.`
          : 'Here is an overview of your projects with Summit Flooring.';
      }

...
(function () {
  ...
  function renderGbb() {
    ...
    cards.innerHTML = ['basic', 'standard', 'premium']
      .map(
        (t) => `
      <button type="button" data-tier="${t}" class="w-full text-left rounded-2xl border-2 border-slate-200 p-4 os-card-tap hover:border-[#d6c4a8]">
        <div class="font-bold text-[#1c1c1f] capitalize">${t === 'standard' ? 'Standard ⭐' : t}</div>
        <div class="text-2xl font-bold text-[#1c1c1f] mt-1 tabular-nums">${money(totals[t])}</div>
  ...
  function bind() {
    ...
    $('modeTotal').addEventListener('click', () => {
      ...
      $('modeTotal').className = 'flex-1 py-2.5 text-xs font-bold bg-[#1c1c1f] text-white';
    ...
    $('modeRooms').addEventListener('click', () => {
      ...
      $('modeRooms').className = 'flex-1 py-2.5 text-xs font-bold bg-[#1c1c1f] text-white';
    ...
    document.querySelectorAll('.svc-card').forEach((btn) => {
      btn.addEventListener('click', () => {
        ...
        document.querySelectorAll('.svc-card').forEach((b) => {
          b.classList.remove('os-card-tap--sel', 'border-[#d6c4a8]');
          b.classList.add('border-slate-200');
        });
        btn.classList.add('os-card-tap--sel', 'border-[#d6c4a8]');
    ...
    $('matWe').addEventListener('click', () => {
      ...
      $('matWe').className = 'flex-1 py-3 bg-[#1c1c1f] text-white';
    ...
    $('matCust').addEventListener('click', () => {
      ...
      $('matCust').className = 'flex-1 py-3 bg-[#1c1c1f] text-white';
  ...
  function init() {
    ...
    $('inputTotalSqft').value = state.totalSqft;
    $('productQty').value = state.productQty;
    document.querySelector('.svc-card[data-svc="installation"]').classList.add('os-card-tap--sel', 'border-[#d6c4a8]');

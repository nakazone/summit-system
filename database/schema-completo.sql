-- Summit Flooring System - Schema Completo do CRM
...
(1, 'Administrador', 'admin@summitflooring.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'admin', 1);
-- Senha padrão: admin123 (ALTERE IMEDIATAMENTE!)

-- Configurações padrão do sistema
INSERT IGNORE INTO `settings` (`key`, `value`, `type`, `description`) VALUES
('company_name', 'Summit Flooring', 'string', 'Nome da empresa'),
('company_email', 'contact@summit-flooring.com', 'string', 'Email principal da empresa'),

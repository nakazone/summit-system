...
function printInternalHostHelp() {
  ...
  console.error('');
  console.error('Opção A — Variáveis no Railway (serviço Node summit-system):');
  ...
  console.error('');
  console.error('Depois (se usares A ou B): railway run -s summit-system npm run migrate:customers-responsible-name');
  console.error('');
}

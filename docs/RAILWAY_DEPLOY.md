...
4. Procure e selecione: **`nakazone/summit-system`**
...
6. A URL será algo como: `https://summit-system-production.up.railway.app`
...
# Deve retornar: {"ok":true,"service":"summit-system","time":"..."}
```
...
- **Railway CLI** (na pasta `summit-system`, com o projeto ligado):  

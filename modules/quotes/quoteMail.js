...
async function sendViaResend({
  ...
  html,
  pdfBuffer,
  filename = 'Summit-Flooring-Quote.pdf',
}) {
  ...
  const body = {
    from: from || fromAddr,
    to: [to],
    subject: subject || 'Your flooring quote from Summit Flooring',
    html:
      html ||
      `<p>Hello,</p><p>Please find your quote attached.</p><p>— Summit Flooring</p>`,
...
export async function sendQuoteEmail({
  ...
  const defaultHtml = publicUrl
    ? `<p>Hello,</p><p>Your quote is ready. <a href="${publicUrl}">View your quote online</a> (full details and PDF are only available on this secure link).</p><p>— Summit Flooring</p>`
    : `<p>Hello,</p><p>Your quote is ready. Please contact Summit Flooring for your secure link.</p><p>— Summit Flooring</p>`;
